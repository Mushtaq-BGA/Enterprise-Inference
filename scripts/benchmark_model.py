...
class ModelBenchmark:
    ...
    async def run_concurrent_requests(self,
        ...
        connector = aiohttp.TCPConnector(limit=concurrency * 2, ssl=ssl_context)
...
def generate_test_prompts(num_prompts: int, prompt_type: str = "varied") -> List[str]:
...
async def main():
    ...
    parser.add_argument(
        "--endpoint",
        default="https://18.237.101.151:32443/v1/chat/completions",
        help="Model endpoint URL (default: LiteLLM HTTPS endpoint)"
    )
    parser.add_argument(
        "--model",
    ...
    parser.add_argument(
        ...
        type=str,
        default="sharegpt",
        help="Dataset to use for prompts (default: sharegpt)"
    )
    ...
    # Generate prompts
    prompts = generate_test_prompts(args.requests, args.prompt_type)
